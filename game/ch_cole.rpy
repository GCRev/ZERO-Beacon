...
label ch_cole:
    ...
    label menu_cole:
        ...
        label cole_advice:
            ...
            cole 'Give me a moment (pauses) alright, I’m going to try to keep this concise because no one likes a rambler. Make friends here and give them your trust. Trust is a "give first and receive later" game, so you have to be the one to stick out your neck and offer it.'
            p 'And what happens if they betray you?'
            cole 'C’mon now, I never said you just walk around with your head down and your hands at your sides. You aren’t asking them marry you. You just have to make some concessions in order to gain something out of an acquaintance. Test the waters before you leap in head-first.'
        ...
        label cole_events:
            ...
            cole 'Rumors don’t speak loudly, son, and in with my older age I do not have the best of hearing any more. So I can’t say that I’ve heard much... Well, actually I have heard some rather harsh things about Irridiss lately. I don’t really know what to make of it, but I don’t think I’m in much of a place to do anything about it, to be honest. (Chuckles a little bit). Why would you ask such a question, just out of curiosity?'
        ...
        label cole_Bg_tree_start:
            ...
            cole 'I\’d prefer not to talk about the past - it\’s not really something I like to share because it is a mood-killer, 
            ...
            label cole_Bg_tree_apologize:
                ...
                menu:
                    cole 'It\’s ok, I didn’t mean to snap at you. Things weren’t always as easy for you kids. As my great grandpappy would say, \'Walking to the Academy was uphill, both ways!\' Oh, he cracked me up.'
                    '[[pursue again]':
                        jump cole_Bg_tree_pursue
                ...
                label cole_Bg_tree_confidentiality:
                    p '"Well, if you ever have anything you want to share with me, you have my complete confidentiality. I’d be happy to listen!'        
                    cole 'Well, you seem like a well mannered kid. Here’s a little about Old Cole.'
                    cole 'I was part of Operation Bridge, on the TSS Destroyer Verdict. I was the Gunnery Officer on board. It was that operation we made first contact with the Kaldreans, actually. Then the fighting began…'
                    cole 'For the most part the Kaldreans were the ones trying to stop the fighting, as a matter fact'
                    cole '...'
                    cole 'But that\’s all water under the bridge, right?'
                    p 'Right! Well thank you very much for sharing on such a fragile tpoic'
