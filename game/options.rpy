...
##
## Lines beginning with two '#' marks are commentFZs, and you shouldn't
...
init -1 python hide:
    ...
    config.screen_height = 715

    ## This controls the title of the window, when Ren'Py is
    ## running in a window.

    config.window_title = u"Beacon"
    ...
    config.main_menu_music = "./assets/mu_title.ogg"
...
python early:
    config.save_directory = "Beacon-1411675480"
...
init python:
    ...
    build.directory_name = "beacon-0.1"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "beacon"
